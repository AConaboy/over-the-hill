...
[Supabase](https://supabase.com) for guest data, and [Resend](https://resend.com) for
RSVP confirmation emails. See `docs/signup-ticketing-spec.md` for the design and
`docs/deployment.md` for how to set this up from scratch.
...
│   ├── lib/             Supabase/Resend clients, guest data access
│   └── pages/
...
Copy `.env.example` to `.env` and fill in real Supabase/Resend values to run
